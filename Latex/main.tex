...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.65]{Example_1/Latex/figs/Map.png}
%\vspace{-10mm}
...
\begin{figure}
  ...
  \begin{subfigure}{0.95\linewidth}
    \centering\includegraphics[width=.5\linewidth]{Example_1/Latex/figs/second.png}
  ...
  \end{subfigure}
  \begin{subfigure}{0.95\linewidth}
    \centering\includegraphics[width=.5\linewidth]{Example_1/Latex/figs/third.png}
    \caption{Extrapolated POIs to be considered as nodes of for the mTSPGA algorithm}
  \end{subfigure}
  \begin{subfigure}{0.95\linewidth}
    \centering\includegraphics[width=.5\linewidth]{Example_1/Latex/figs/fourth.png}
  ...
  \end{figure}
    % \centering
    % \begin{subfigure}
    % \includegraphics[width=0.60\textwidth]{Example_1/Latex/figs/second.png}
    ...
    % \end{subfigure}
    % % \subfigure{\includegraphics[width=0.48\textwidth]{Example_1/Latex/figs/third.png}} 
    % % \subfigure{\includegraphics[width=0.48\textwidth]{Example_1/Latex/figs/fourth.png}}
...
% \begin{figure}[!htbp]
% \centering
% \includegraphics[scale=0.65]{Example_1/Latex/figs/second.png}
% %\vspace{-10mm}
...
\bibliography{Example_1/Latex/bib}
