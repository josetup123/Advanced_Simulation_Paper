...
%
\SCSpagesetup{C\'{a}rdenas and Oakes}
...
\author[\authorrefmark{1} \authorrefmark{2}]{Rom\'{a}n C\'{a}rdenas}
\author[\authorrefmark{3}]{Bentley James Oakes}

% Department and university with the mark
\affil[\authorrefmark{1}]{Integrated Systems Laboratory, Universidad Polit\'{e}cnica de Madrid, Spain}
% emails in the next line in italics
\affil[ ]{\textit {r.cardenas@upm.es}}
...
\affil[\authorrefmark{3}]{Computer and Software Engineering, Polytechnique Montréal, Canada}
